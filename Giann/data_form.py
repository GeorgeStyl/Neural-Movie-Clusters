...
arr = np.load('datasets/dataset_final.npy', allow_pickle=True)
...
# Since no zero ratings are found in either the cleaned or raw dataset, we can conclude that the absence of a rating
# is not encoded using the value 0, and further manipulation is needed in next scripts, in order to complete
# task 4 of data preprocessing
